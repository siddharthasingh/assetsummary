...
public class KafkaConfig {/*
	...
	public KafkaMessageListenerContainer<String, String> container() throws Exception {
		Long offsetVal = assetDao.getAssetOffset();
		return new KafkaMessageListenerContainer<>(consumerFactory(),
				new ContainerProperties(new TopicPartitionInitialOffset(this.assetTopic, 0, offsetVal+1)));
	}
	...
	public ConsumerFactory<String, String> consumerFactory() {
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "ao_asset_grp");
